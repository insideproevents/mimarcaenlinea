...
{showSocials && (
            <>
              ...
              <div className="absolute -bottom-3 -left-3 w-8 h-8 md:w-10 md:h-10 bg-black animate-float-fast rounded-full flex items-center justify-center shadow-lg z-30">
