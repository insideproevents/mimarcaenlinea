...
{showSocials && (
            <>
              ...
              <div className="absolute -bottom-4 -left-4 w-8 h-8 md:w-10 md:h-10 bg-black animate-float-fast rounded-full flex items-center justify-center shadow-lg z-30">
