...
{showSocials && (
            <>
              ...
              <div className="absolute bottom-[18px] left-[18px] md:bottom-2 md:left-2 w-8 h-8 md:w-10 md:h-10 bg-black animate-float-fast rounded-full flex items-center justify-center shadow-lg z-30">
