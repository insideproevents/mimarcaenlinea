    ...
    >
      <div className="animate-float">
        ...
        >
          ...
          {showBubble && (
            <div key="bubble" className="absolute -top-16 left-1/2 md:-top-20 -translate-x-1/2 mb-2 w-48 md:w-[18rem] z-20 pointer-events-none animate-bounce-in" style={{ animationDelay: '0.1s' }}>
                <div 
