...
const translations: Translations = {
  ...
  'portfolio.project2.desc': { es: 'Sitio web profesional para empresa.', en: 'Professional website for company.' },
  ...
  'portfolio.project4.title': { es: 'Landing Emprendedor', en: 'Entrepreneur Landing' },
  'portfolio.project4.category': { es: 'Web Personal', en: 'Personal Website' },
  'portfolio.project4.desc': { es: 'Sitio web basico para emprendedores.', en: 'Basic website for entrepreneurs.' },
