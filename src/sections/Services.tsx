          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                {/* Background Image */}
                <div 
                  className="absolute inset-0 rounded-[10%] grayscale opacity-20 group-hover:opacity-50 transition-opacity duration-300"
                  style={{
                ...
                <div className="relative z-10">
                  ...
                  <div className="w-12 h-12 mb-6 flex items-center justify-center">
                    <Icon className="w-8 h-8 text-white transition-all duration-300 group-hover:scale-110" strokeWidth={1.5} />
                  </div>
